# This file was modified to include AUTHOR_NAME parameter by Leland Taylor
# on Oct 28, 2017
...
#
# OTHER
# AUTHOR_NAME allows to add bold your authorship
AUTHOR_NAME		?= "NO_NAME"
# EXTERNAL PROGRAMS:
# = ESSENTIAL PROGRAMS =
...
run-bibtex	= $(BIBTEX) $1 | $(color_bib);\
	$(call transcript,bibtex,$1);\
	$(SED) s/"$(AUTHOR_NAME)"/"\\\textbf{$(AUTHOR_NAME)}"/g $1.bbl > temp.bbl;\
	mv temp.bbl $1.bbl
